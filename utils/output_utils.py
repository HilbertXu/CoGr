...
def draw_lincomb(proto_data, masks, img_name, target_dir=None):
    ...
    for kdx in range(1):
        ...
        if target_dir is None:
            cv2.imwrite(f'results/grasps/lincomb_{img_name}', arr_img)
        else:
            cv2.imwrite(f'{target_dir}/lincomb_{img_name}', arr_img)
